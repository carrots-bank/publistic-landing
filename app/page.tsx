        ...
        <div>
          <ScrollReveal y={18}>
            <h1 className="h1 font-mont">
              Будущее публикаций
              <span className="block accent-text">в Telegram</span>
            </h1>
          </ScrollReveal>

          <ScrollReveal y={12} delay={0.06}>
            <p className="sub mt-5 max-w-xl">
              Ваш персональный AI-ассистент для канала: умные посты, горячие темы и полная автоматизация.
              Кастомные решения и полный контроль публикаций через предпросмотр.
            </p>
          </ScrollReveal>
          ...
          <ScrollReveal y={10} delay={0.18}>
            <p className="mt-4 text-sm text-muted">Каналы любого размера. Вы утверждаете публикации.</p>
          </ScrollReveal>
        </div>
          ...
          <ScrollReveal y={18}>
            <div className="card">
              ...
              <p className="sub mt-3">
                Люди устают, пропускают тренды и сроки. Publistic анализирует десятки каналов и медиа в реальном времени,
          ...
          <div>
            ...
            <ScrollReveal y={12} delay={0.06}>
              <p className="text-muted mt-4">
                Мы берём сложные технологии и делаем их простыми: подключаем источники, подбираем темы, готовим посты, вы утверждаете — и
                публикации выходят точно по плану.
              </p>
            </ScrollReveal>
...
const features = [
  { icon: "📡", title: "Аналитика в реальном времени", text: "Telegram-каналы + новости/интернет." },
  { icon: "✍️", title: "AI-контент любого формата", text: "Текст, фото, видео, аудио." },
  { icon: "🔥", title: "Горячие темы", text: "Выбираем сюжеты по вовлечённости." },
  { icon: "🎨", title: "Индивидуальный стиль", text: "Тон и язык под вашу аудиторию." },
  { icon: "⏰", title: "Гибкий график", text: "Частота и время публикаций под вас." },
  { icon: "🖼", title: "Водяные знаки и брендинг", text: "Защита медиа и узнаваемость." },
  { icon: "📢", title: "Рекламные посты", text: "Нативные и промо-форматы." },
  { icon: "✅", title: "Предпросмотр и контроль", text: "Вы утверждаете публикации." },
];

const steps = [
  { title: "Созваниваемся: цели, тематика, стиль.", text: "Фиксируем KPI и формат работы." },
  { title: "Настраиваем ассистента и интеграции.", text: "Подключаем источники и шаблоны." },
  { title: "Получаете предпросмотр постов.", text: "Выбираете/редактируете темы." },
  { title: "Постинг по расписанию.", text: "Наблюдаете рост, регулируете параметры." },
];

const benefits = [
  "Экономия на постоянных расходах на админов.",
  "Время владельца — на стратегию и партнёрства.",
  "Точность и регулярность без срывов.",
  "Масштабируемость под любые объёмы.",
  "Год поддержки: баг-фиксы, ответы, помощь.",
